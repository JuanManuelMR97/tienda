...
class Productos extends CI_Controller {
    ...
    public function destacados() {
        $config['base_url'] = site_url('Productos/destacados/'); //Parámetro base de la aplicación
        ...
        $this->load->view('productos', $data); //Cargamos la vista y le pasamos el array data
    }
    ...
    public function por_categorias($categoria_id) {
        ...
        $config['total_rows'] = $this->Productos_model->filas();
        $config['per_page'] = 6;
